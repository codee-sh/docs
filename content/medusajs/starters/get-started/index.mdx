...
Want to share your starter with the community? Open a pull request to the [medusa-hub](https://github.com/codee-sh/medusa-hub) repository with your starter content. Use the [template](/medusajs/starters/get-started/template) to structure your submission — see [Astro Medusa Starter](/medusajs/starters/astro-medusa-starter/get-started) as a reference example.
