...
Want to share your starter with the community? Open a pull request to the [medusajs-hub-docs](https://github.com/codee-sh/medusajs-hub-docs) repository with your starter documentation. Use the [template](/medusajs/starters/get-started/template) to structure your submission — see [Astro Medusa Starter](/medusajs/starters/astro-medusa-starter/get-started) as a reference example.
