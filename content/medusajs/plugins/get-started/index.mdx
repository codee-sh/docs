...
Want to share your plugin with the community? Open a pull request to the [medusa-hub](https://github.com/codee-sh/medusa-hub) repository with your plugin content. Use the [template](/medusajs/plugins/get-started/template) to structure your submission — see [Automations](/medusajs/plugins/automations/get-started) or [Notifications](/medusajs/plugins/notifications/get-started) as a reference example.
